1. ### <a name="_toc496253845"></a>**虚拟子账户绑定的代理支付**
...
（3）财务公司实体扣款账户至开户行通过柜面3392交易登记成员企业内部账户（自定义不超过18位）和虚拟子账户一一对应关系，代理模式为全替换。在同一扣款账号下，一个企业内部账号只能和该扣款账号下的一个虚拟子账户一一对应，不允许一对多或多对一。
